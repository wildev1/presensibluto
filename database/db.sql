...
-- Tabel Roles Permission (Relasi Many-to-Many)
...
-- Tabel Users Roles (Relasi Many-to-Many)
...
VALUES (
        MD5('1'),
        'lembaga Apins Digital',
        '1234567890',
        '0987654321',
        'Jl. Raya lembaga No. 123',
        'Kota',
        'Kabupaten A',
        'Provinsi X',
        'logo.png',
...
CREATE TABLE santri (
    ...
    rayon_id VARCHAR(50),
    tahun_ajaran_id VARCHAR(50),
    persentase_tagihan_id VARCHAR(50),
