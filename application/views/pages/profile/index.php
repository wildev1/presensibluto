                            ...
                            <div class="row" align="center">
                                <div class="col-sm-12">
                                    <div  style="margin-top: 4px; margin-bottom: 4px;">
                                        <img src="<?php echo base_url('upload/logo/'); ?>" class="img-thumbnail rounded-circle" style="width: 100px; height: 100px;">
                                    </div>
                                    <h5 class="font-size-15 text-truncate">test</h5>
                                    <p class="text-muted mb-0 text-truncate">admin</p>
                                    <div class="mt-2">
                                        <a href="" class="btn btn-primary waves-effect waves-light btn-sm" data-toggle="modal" data-target=".lembagass>Edit
                                ...
                                <table class="table table-nowrap mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="<?php echo base_url('upload/qrcode/'); ?>" style="width: 70px; height: 70px;">											</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
