 <?php foreach ($users_shift_groups as $user_shift_group): ?>
    <div class="modal fade add<?php echo $user_shift_group->users_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php echo form_open('usersShiftGroup/create'); ?>
                        ...
                        <div class="form-group">
                            <label for="group_shift_id">Group Shift</label>
                            <select id="group_shift_id" class="form-control" name="group_shift_id">
                                <?php foreach ($shift_groups as $shift_group): ?>
                                    <option value="<?php echo $shift_group->group_shift_id; ?>">
                                        <?php echo $shift_group->group_shift; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
